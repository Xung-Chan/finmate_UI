        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = "Available balance: 10.000.000 VNĐ",
                        style = CustomTypography.titleMedium,
                        color = Blue1
                    )
                }
                Row(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Người thụ hưởng đã lưu", style = CustomTypography.titleMedium,
                            color = Gray1
                        )
                ...
                Column(
                    ...
                    CustomTextField(
                        value = "",
                        placeholder = {
                            Text("Tên người thụ hưởng", style = CustomTypography.titleMedium,
                                color = Gray2)
                        },
                        enable = false,
                        readOnly = true,
                ...
                Column(
                    ...
                    CustomTextField(
                        value = "",
                        placeholder = {
                            Text("Số tiền", style = CustomTypography.titleMedium,
                                color = Gray2)
                        },
                        keyboardOptions = KeyboardOptions(
                            keyboardType = KeyboardType.Number,
                    ...
                    CustomTextField(
                        value = "",
                        placeholder = {
                            Text("Nội dung chuyển khoản", style = CustomTypography.titleMedium,
                                color = Gray2)
                        },
                        keyboardOptions = KeyboardOptions(
