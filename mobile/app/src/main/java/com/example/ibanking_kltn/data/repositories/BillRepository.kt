...
import com.example.ibanking_kltn.data.dtos.responses.FilterBillResponse
...
//        return safeApiCall { billApi.preparePayBill(request) }
    ...
    suspend fun filterBill(request: FilterBillRequest): ApiResult<FilterBillResponse> {
//        return safeApiCall {
//            billApi.filterBill(
